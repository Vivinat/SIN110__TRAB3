...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = 'C:/Users/Particular/Desktop/PYTHON/TRAB2/grafo/Instancias/' + instancia + '.txt'
...
def salvaResultado(resultado):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('C:/Users/Particular/Desktop/PYTHON/TRAB2/grafo/Resultados/resultado.txt', 'a+')
